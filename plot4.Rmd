...
voltage <- as.numeric(householdConsumption$Voltage)
reactiveG <- as.numeric(householdConsumption$Global_reactive_power)
...
plot(timedat,voltage, type = "l", xlab = "datetime", ylab = "voltage")
...
plot(timedat,reactiveG, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
